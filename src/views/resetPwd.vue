  ...
  <div class="login">
    <el-form ref="loginResetForm" :model="loginResetForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="mobile">
        <el-input v-model="loginResetForm.mobile" type="text" auto-complete="off" placeholder="请填写手机号">
          <svg-icon slot="prefix" icon-class="user" class="el-input__icon input-icon" />
        </el-input>
      </el-form-item>
      <el-form-item prop="oldPassword">
        <el-input
          v-model="loginResetForm.oldPassword"
          type="password"
          auto-complete="off"
          placeholder="当前密码"
        >
      ...
      <el-form-item prop="newPassword">
        <el-input
          v-model="loginResetForm.newPassword"
          type="password"
          auto-complete="off"
          placeholder="新密码"
        >
